...
rtree: buffer_manager.o file_manager.o tree.o bulk.o main.o
	g++ -std=c++11 -o rtree buffer_manager.o file_manager.o tree.o bulk.o main.o
...
main.o: main.cpp
	g++ -Wall -Wextra -pedantic -std=c++11 -O2 -Wshadow -Wformat=2 -Wfloat-equal -Wconversion -Wlogical-op -Wshift-overflow=2 -Wduplicated-cond -Wcast-qual -Wcast-align -o main.o -c main.cpp 

testt.o: testAllocateNode.cpp
	g++ -std=c++11 -o testt.o -c testAllocateNode.cpp

tree.o: Rtree.cpp
	g++ -Wall -Wextra -pedantic -std=c++11 -O2 -Wshadow -Wformat=2 -Wfloat-equal -Wconversion -Wlogical-op -Wshift-overflow=2 -Wduplicated-cond -Wcast-qual -Wcast-align -o tree.o -c Rtree.cpp 
